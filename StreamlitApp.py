...
def models():
    CAE_model = load_model("C:\\Users\\Viraj Sawant\\Desktop\\StreamlitApp\\autoencoder_model.h5")
    SEGNET_model = load_model("C:\\Users\\Viraj Sawant\\Desktop\\StreamlitApp\\segnet_model.h5")
    birads_model = joblib.load("C:\\Users\\Viraj Sawant\\Desktop\\StreamlitApp\\birads_regressor_model.pkl")
    class_model = joblib.load("C:\\Users\\Viraj Sawant\\Desktop\\StreamlitApp\\cancer_classification_model.pkl")

    ohe_encoder = joblib.load("C:\\Users\\Viraj Sawant\\Desktop\\StreamlitApp\\cat_encoder1.pkl")
